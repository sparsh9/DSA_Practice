...
// also, for the preorder, which is the numbers of elements(number of elements = total elements in the new inorder) to right of the root will be the new preorder and all the remaining elements will be new preorder for right subtree
